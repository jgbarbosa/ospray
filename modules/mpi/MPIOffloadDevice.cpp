...
namespace ospray {
  namespace mpi {
    ...
    */
    void createMPI_RanksBecomeWorkers(int *ac, const char **av, work::WorkTypeRegistry& registry)
    {
      mpi::init(ac,av,true);
    ...
    */
    ...
    void createMPI_connectToListener(int *ac, const char **av,
                                     const std::string &host, work::WorkTypeRegistry& registry)
    {
      mpi::init(ac,av,true);
